...
module HostCommon
  ...
  # The Puppet server hostname that's also available as a provisioning macro
  def puppetmaster
    puppetmaster_uri.try(:host)
  end
  ...
  # The Puppet CA server hostname that's also available as a provisioning macro
